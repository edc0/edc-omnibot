...
void loop (void)
{
  ...
  erro2 = inp/2 - rps2_avg;
  erro3 = inp/3 - rps3_avg;
  ...
  {
    gpioPWM(M1a, 0);
    gpioPWM(M1b, int(val1_new+120));
  }
  if(val1_new < 0)
  {
    gpioPWM(M1a, -int(val1_new+120));
    gpioPWM(M1b, 0);
  }
  if(val2_new > 0)
  {
    gpioPWM(M2a, 0);
    gpioPWM(M2b, int(val2_new+120));
  }
  if(val2_new < 0)
  {
    gpioPWM(M2a, -int(val2_new+120));
    gpioPWM(M2b, 0);
  }
  if(val3_new > 0)
  {
    gpioPWM(M3a, 0);
    gpioPWM(M3b, int(val3_new+120));
  }
  if(val3_new < 0)
  {
    gpioPWM(M3a, -int(val3_new+120));
    gpioPWM(M3b, 0);
  }
